	        	...
	        	<tr>
	                <td align="center" valign="top" id="hdc_ac">
	                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">
							<tbody>
								<tr>
									<td align="center" bgcolor="#eb2929" valign="top" id="" style="background-color:{MAIL-BACKGROUND-HEAD};padding-right:30px;padding-left:30px">			
																		...
																		<tbody>
																			<tr>
																				<td align="left" valign="top" id="" style="padding-bottom:40px">
																					<h1 style="color:#606060;text-decoration:underline;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:30px;font-style:normal;font-weight:600;line-height:42px;letter-spacing:normal;margin:0;padding:0;text-align:center">
